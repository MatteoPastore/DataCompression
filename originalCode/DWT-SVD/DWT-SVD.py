...
class watermarking():
    ...
    :param level:
    """
    def __init__(self, watermark_path="0000.bmp", ratio=0.1, wavelet="haar",
                 level=2):
        self.level = level
    ...
    def watermark(self, img="0001.bmp", path_save=None):
        '''
...
if __name__ == '__main__':
    ...
    watermarking.watermark(img='0001.bmp', path_save=None)
