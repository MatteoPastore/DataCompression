...
def DFT(coverImage, watermarkImage):
    ...
    cv2.imwrite("./DFTonlyResults/Watermarked/DFTonly_"+path[9:], watermarkedImage)
    cv2.imwrite("./imagesToAttack/" + "DFTonly_" + path[9:], watermarkedImage)
...
def DCT(coverImage, watermarkImage):
    ...
    cv2.imwrite("./DCTonlyResults/Watermarked/DCTonly_" + path[9:], watermarkedImage_8)
    cv2.imwrite("./imagesToAttack/" + "DCTonly_" + path[9:], watermarkedImage_8)
...
def SVD(coverImage, watermarkImage):
    ...
    cv2.imwrite("./SVDonlyResults/Watermarked/SVDonly_" + path[9:], watermarkedImage*255)
    cv2.imwrite("./imagesToAttack/" + "SVDonly_" + path[9:], watermarkedImage*255)
