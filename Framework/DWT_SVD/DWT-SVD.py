...
class watermarking():
    ...
    :param level:
    """
    def __init__(self, watermark_path="Lenna.jpg", ratio=0.1, wavelet="haar",
                 level=2):
        self.level = level
    ...
    def watermark(self, img, path_save=None):
        ...
        '''
        if not path_save:
            path_save = "watermarked_immagine.jpeg"
...
if __name__ == '__main__':
    ...
    img=cv2.imwrite("../resizedImages/Obama2.jpg", img)
    #img2=cv2.imread("Lenna.jpg")
    #print(img2.shape)
    #print(img.shape)
    watermarking = watermarking(level=3)
    watermarking.watermark(img="Obama2.jpg", path_save=None)
    #watermarking.extracted(image_path="watermarked_cameraman.jpeg",extracted_watermark_path = None)