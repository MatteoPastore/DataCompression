...
def DFT(coverImage, watermarkImage):
    ...
    cv2.imwrite("./DFTonlyResults/Watermarked"+path[9:], watermarkedImage)
...
def DWT(coverImage, watermarkImage):
    ...
    cv2.imwrite("./DWTonlyResults/Watermarked"+path[9:], 255*watermarkedImage)
    ...
    cv2.imwrite("./DWTonlyResults/Extracted" + path[9:], extracted)
...
def DCT(coverImage, watermarkImage):
    ...
    cv2.imwrite("./DCTonlyResults/Watermarked" + path[9:], watermarkedImage_8)
...
def SVD(coverImage, watermarkImage):
    ...
    cv2.imwrite("./SVDonlyResults/Watermarked" + path[9:], watermarkedImage*255)
...
def DWT_SVD(coverImage, watermarkImage):
    ...
    cv2.imwrite("./DWT_SVDresults/Watermarked" + path[9:], watermarkedImage*255)
...
def DWT_DCT_SVD(coverImage, watermarkImage):
    ...
    cv2.imwrite("./DWT_DCT_SVDresults/Watermarked" + path[9:], watermarkedImage*255)


if __name__ == "__main__":
    coverImage = cv2.imread('Images/0001.bmp', 0)
    watermarkImage = cv2.imread('Images/0000.bmp', 0)
