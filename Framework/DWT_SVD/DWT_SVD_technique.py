...
class watermarking():
    ...
    def watermark(self, img, path_save=None):
        ...
        #print(img)
        if not path_save:
            path_save = "C:\\Users\\matte\\PycharmProjects\\DataCompression\\DWT_SVD_results\\watermarked_" + img[16:]
            #print(path_save)
    ...
    def extracted(self, image_path=None, ratio=None, extracted_watermark_path = None):
        ...
        '''
        #print("Prova"+image_path)
        if not extracted_watermark_path:
            extracted_watermark_path = "C:\\Users\\matte\\PycharmProjects\\DataCompression\\DWT_SVD_results\\extracted_"+image_path[63:]
            #print(image_path[63:])
        if not image_path:
...
def resize(path, watermark):
    dim = (512, 512)
    #print(watermark[9:])
    newPath="./resizedImages/"+watermark[9:]
    #print("../resizedImages/"+watermark[9:])
...
def launch(path, watermark):
    ...
    watermarked="C:\\Users\\matte\\PycharmProjects\\DataCompression\\DWT_SVD_results\\watermarked_"+path[9:]
    watermark_class=watermarking(watermark_path="./resizedImages/"+watermark[9:])
